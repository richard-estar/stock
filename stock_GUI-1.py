...
class StockApp:
    def __init__(self):
        ...
        # Create Window
        self.root = Tk()
        self.root.title("ESS Stock Manager")
        ...
        for stock in self.stock_list:
            if stock.symbol == symbol:
                ...
                if count > 0:
                    ...
                    self.stockReport.insert(END,"Low Price: " + 
"${:,.2f}".format(lowPrice) + "\n")
                    self.stockReport.insert(END,"High Price: " + 
"${:,.2f}".format(highPrice) + "\n")
                    self.stockReport.insert(END,"Average Price: " + 
"${:,.2f}".format(price_total/count) + "\n\n")
                    self.stockReport.insert(END,"Low Volume: " + str(lowVolume) + 
"\n")
                    self.stockReport.insert(END,"High Volume: " + str(highVolume) + 
"\n")
                    self.stockReport.insert(END,"Average Volume: " + 
"${:,.2f}".format(volume_total/count) + "\n\n")
                    self.stockReport.insert(END,"Change in Price: " + 
"${:,.2f}".format(priceChange) + "\n")
                    self.stockReport.insert(END,"Profit/Loss: " + 
"${:,.2f}".format(priceChange * stock.shares) + "\n")
                else:
